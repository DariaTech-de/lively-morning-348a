...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lively-morning-348a)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lively-morning-348a
```

A live public deployment of this template is available at [https://lively-morning-348a.templates.workers.dev](https://lively-morning-348a.templates.workers.dev)
